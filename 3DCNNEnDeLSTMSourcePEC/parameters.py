...
class parameter(object):
    ...
    def __init__(self):
        ...
        parser.add_argument('--epochs', type=int, default=3e4, help='number of epochs to train for')
        ...
        parser.add_argument('--n_hidden_dim', type=int, default=128, help='number of hidden dim for ConvLSTM layers')
        parser.add_argument('--n_input_channels', type=int, default=4, help='number of input channel for ConvLSTM layers')
        parser.add_argument('--n_output_channels', type=int, default=1, help='number of output channel for ConvLSTM layers')
        parser.add_argument('--n_domain_dim', type=int, default=64, help='number of domain dimensions for simulation')
