...
class EncoderDecoderConvLSTM(nn.Module):
    def __init__(self, nf, in_chan):
        ...
        self.encoder_4_convlstm = ConvLSTMCell(input_dim=nf,
                                               ...
                                               kernel_size=(3, 3),
                                               bias=True)
        self.encoder_5_convlstm = ConvLSTMCell(input_dim=nf,
                                               hidden_dim=nf,
                                               kernel_size=(3, 3),
                                               bias=True)
    ...
    def autoencoder(self, x, seq_len, future_step, h_t, c_t, h_t2, c_t2, h_t3, c_t3, h_t4, c_t4):
        ...
        for t in range(future_step):
            h_t3, c_t3 = self.decoder_1_convlstm(input_tensor=encoder_vector,
                                                 cur_state=[h_t3, c_t3])
            h_t4, c_t4 = self.decoder_1_convlstm(input_tensor=h_t3,
                                                 cur_state=[h_t4, c_t4])
            encoder_vector = h_t4
            outputs += [h_t4]
        ...
        return outputs, h_t, h_t2, h_t3, h_t4

    def forward(self, x, h_t,  h_t2,  h_t3, h_t4, c_t, c_t2, c_t3, c_t4):
        """
            Parameters
            ----------
            input_tensor:
        ...
        outputs, h_t, h_t2, h_t3, h_t4 = self.autoencoder(x, seq_len, future_seq, h_t, c_t, h_t2, c_t2, h_t3, c_t3, h_t4, c_t4)
        return outputs, h_t, h_t2, h_t3, h_t4
